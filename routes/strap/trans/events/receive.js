...
function recieveObj(req, res) {
    ...
    req.body.objArray.forEach(function (obj) {
        if (obj.damaged === 'N') {
            binVars = [obj.objId, obj.type, 'Received', new Date(), locId, null, obj.objLbl, obj.partNo, obj.qty || 0, obj.invId, userId, obj.comments, 0, ts, null, null, partGrp, lr, null, null];
        } else {
            binVars = [obj.objId, obj.type, 'Review', new Date(), locId, null, obj.objLbl, obj.partNo, obj.qty || 0, obj.invId, userId, obj.comments, 0, ts, null, null, partGrp, lr, null, null];
        }
        if (invArr.indexOf() < 0) {
